...
class Leaf(Node):
    def __init__(self, parent: Union[None, 'Node']=None, prev_node: Union[None, 'Node']=None, next_node: Union[None, 'Node']=None):
        """
...
class BPlusTree(object):
    ...
    def __setitem__(self, key, value: Dict, leaf=None):
