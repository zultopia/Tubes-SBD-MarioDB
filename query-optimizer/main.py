...
if (current == 'gana'):
    ...
    plans = generate_possible_plans(query_plan, [EquivalenceRules.deconstruct_conjunction,EquivalenceRules.combineJoinCondition,EquivalenceRules.switchChildrenJoin,EquivalenceRules.associativeJoins])
