...
#     def __init__(self, data_item: DataItem, parent: 'GranularityNode' = None, children: List['GranularityNode'] = None):
#         self.node = data_item
#         self.lock_IS = set()
#         self.lock_IX = set()
#         self.lock_S = set()
...
#     def __init__(self):
#         self.root = GranularityNode(DataItem('database', Database()))            
...
#         # while stack:
#         #     current_add_node = stack.pop()
#         #     if current_add_node in current_tree_node.children:
#         #         current_tree_node = 
